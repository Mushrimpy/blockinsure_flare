...
export function useDeployedContractInfo<TContractName extends ContractName>(
  ...
  const deployedContract = contracts?.[selectedNetwork.id as keyof typeof contracts]?.[String(contractName) as keyof (typeof contracts)[keyof typeof contracts]] as Contract<TContractName>;
